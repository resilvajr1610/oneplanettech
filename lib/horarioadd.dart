...
class HorarioAdd extends StatefulWidget {
  DocumentSnapshot usuario;

  HorarioAdd(this.usuario);

  @override
  _HorarioAddState createState() => _HorarioAddState();
}

class _HorarioAddState extends State<HorarioAdd> {
  ...
  void initState() {
    ...
    Pesquisa().sendAnalyticsEvent(tela: Nomes().horarioAdd);
  ...
  void buscarcursos() {
    FirebaseFirestore.instance
      ...
      if (List<String>.from(widget.usuario['curso']).contains('Todos')) {
        ...
        List<String>.from(value['horarios']).forEach((element) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //     parasalvar, "Adicionar Horário", "Salvar", context),
      body: Row(
  ...
  //   } else {
  //     if (opcao == 0) {
  //       Pesquisa().salvarhorariounidade(widget.usuario, unidade, imagem,
  //           imagemweb, pdfapp, pdfweb, ctitulo.text);
  //       Layout().dialog1botaofecha2(
  //           context, "Salvando", "Logo aparecerá em Horários. ");
  //     }
  //     if (opcao == 1) {
  //       Pesquisa().salvarhorariocurso(widget.usuario, unidade, curso, imagem,
  //           imagemweb, pdfapp, pdfweb, ctitulo.text);
  //       Layout().dialog1botaofecha2(
  //           context, "Salvando", "Logo aparecerá em Horários.");
  //     }
  ...
  //       } else {
  //         Pesquisa().salvarhorarioturmas(widget.usuario, unidade, imagem,
  //             imagemweb, pdfapp, pdfweb, ctitulo.text,
